...
namespace HouseholdBudgetPlanner
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            IncomeTypeListService incomeTypeListService = new IncomeTypeListService();
            IncomeTypeManager incomeTypeManager = new IncomeTypeManager(incomeTypeService, incomeTypeListService);
            AmountListService amountListService = new AmountListService();
            AmountManager amountManager = new AmountManager(actionService, amountService, amountListService);
            ...
            AmountManagerAdd amountManagerAdd = new AmountManagerAdd(amountService, amountManagerAddExpense, amountManagerAddIncome, amountListService);
